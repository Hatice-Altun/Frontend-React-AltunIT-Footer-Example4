                ...
                <div className="secContent container">
                    ...
                    <div className="contactDiv flex">
                        ...
                        <div className="inputDiv flex">
                            ...
                            <button data-aos="fade-up" className="btn flex" type='submit'> SEND < FiSend
                    ...
                    <div className="footerCard flex">
                        ...
                        <div className="footerIntro flex">
                            ...
                            <div data-aos="fade-up" className="footerParagraph">
                                ...
                                Whether you're a seasoned traveler or embarking on your first journey, our mission is to
                                provide you with unforgettable experiences and help you create memories that last a
                                lifetime.
                                From breathtaking landscapes to vibrant cultures, we strive to showcase the beauty and
